...
TagProperties::TagProperties(const QSharedPointer<Tag>& tag, QWidget* parent)
...
QSharedPointer<Tag> TagProperties::tag() const
{
	return m_tag;
}

void TagProperties::setTag(const QSharedPointer<Tag>& tag)
{
	m_tag = tag;
	if (m_tag)
		populate();
